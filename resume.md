...
- **Tools**: GitLab CI/CD, GitHub Actions, CircleCI, ArgoCD, Docker, Terraform, Terragrunt, Ansible, Prometheus, Grafana, Loki, Tempo, Opentelemetry, Helm, Cortex, Thanos, Istio, Rook, Kafka, Vault
