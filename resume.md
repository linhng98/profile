...
- **Tools**: GitLab CI/CD, GitHub Actions, ArgoCD, Docker, Terraform, Terragrunt, Ansible, Prometheus, Grafana, Helm, Cortex, Thanos, Istio, Rook, Kafka, Loki
- **Programming Languages**: Go, Python, C
- **Framework**: Gin, Gorm, FastAPI, SQLAlchemy

## Experiences
- **Site Reliability Engineer (October 2021 - Present) – Teko**
...
- **System Engineer (March 2019 - December 2019) – VNG Corporation**
  ...
  - Build clients and servers for communication applications utilizing TCP protocol, C socket and multithreading
